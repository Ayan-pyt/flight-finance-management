...
import React, { useState, useEffect } from 'react';
import { Plane, Home, Search, MessageSquare, Users, LogOut, Menu, X, PlusCircle, Ticket } from 'lucide-react';
...
import FlightManagement from './components/FlightManagement';
import MyBookings from './components/MyBookings'; // Import the new component
...
function App() {
  ...
  const navigationItems = [
    { id: 'dashboard', icon: Home, label: 'Dashboard' },
    { id: 'flights', icon: Search, label: 'Flights' },
    // Conditionally add 'My Bookings' only for regular users
